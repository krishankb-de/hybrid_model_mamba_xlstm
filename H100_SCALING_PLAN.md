...
>
> ### ⚡ PLAN REOPENED AGAIN 2026-09-13 — PHASE 15 (second supervisor review, thesis strength). `current_phase: phase15_thesis_strength`.
...
#### 15A — Published field-baseline table 🟡 DRAFTED 2026-09-13 (`analysis/PUBLISHED_BASELINES.md`, commit ccf59ad) — 3 gaps open
...
#### 15D — Retrieval framing ⏳ NOT STARTED (edits only, no compute)

- [ ] **15D-1** — Audit every retrieval claim in `analysis/h100_scaling_results.md` §2, `analysis/PHASE14_SUPERVISOR_REVIEW.md`, `README.md`, and `h100_scaling_state.json["primary_thesis"]` against the supervisor's note. §2 is already titled *"Retrieval (Supporting Chapter)"*, so this is expected to be small — but state explicitly, once, that the chapter **trails the best specialised retrieval architecture**, and make sure no summary line reads as a headline claim.
