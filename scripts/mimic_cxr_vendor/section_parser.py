# Vendored VERBATIM from the official MIT-LCP MIMIC-CXR repository.
#
#   Source:  https://github.com/MIT-LCP/mimic-cxr/blob/master/txt/section_parser.py
#   Commit:  e8d26fff0fe1632f6cf53d31158e888cffb18ab8 (2019-09-25, "rename report folder txt")
#   Fetched: 2026-08-16
#
# Reason for vendoring rather than writing our own regex: Phase 8C of
# H100_SCALING_PLAN.md. Provenance is the stated reason for building the CXR
# corpus from PhysioNet directly instead of the third-party HF mirror
# (itsanmolgupta/mimic-cxr-dataset), whose section parser is unknown and
# unauditable. Shipping a homegrown regex here would forfeit that benefit.
#
# DO NOT EDIT. If the upstream file changes, re-fetch and update the commit
# SHA above rather than hand-patching this copy.
